...
const laws = [
  ...
  [
    "Вероника должна мыть кальян в течение часа (трубка должна продуваться)",
    "Лишение кальяна три дня",
  ],
  ...
  [
    "Не будить питука и не трогать Веронику за голову когда будишь до 8:30",
    "20 минут зарядка",
  ],
  ...
  [
    "Не причинят телесные повреждения питукстанцу",
    "Покупка то что пожелает питукстанец",
  ],
  [
    "Не оскорблять честь и достоинство питукстанца и его матери",
    "Питукстанец сам определяет наказание",
  ],
  [
  ...
  [
    "Питукстанцы должны чистить зубы с 9 до 11",
    "Вер: на 15 минут раньше на некст день  Влад : один раз моет посуду в этот день",
  ],
